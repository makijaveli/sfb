	...
	<header class="orange">
		...
		<div class="headerup">
			...
			<div class="wrapper">
				...
				<div class="seacrhexpand">
					...
					<form class="Search orange" method="get" action="<?php bloginfo('home'); ?>/">
				  <input type="text" class="Search-box orange" name="s" id="Search-box" placeholder="Search...">
				...
				<?php get_template_part('template_parts/social-icons');?>
		...
		<div class="headerlogo">
			...
			<?php if (stl_is_current_cyrillic()) { ?>
				<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/logo-orange-cir.png" alt="Šumarski fakultet"></a>
			<?php } else { ?>
				<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/logo-orange.png" alt="Šumarski fakultet"></a>
			<?php } ?>
		</div>
