	...
	<header class="green">
		...
		<div class="headerlogo">
			...
			<?php if (stl_is_current_cyrillic()) { ?>
				<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/logo-green-cir.png" alt="Šumarski fakultet"></a>
			<?php } else { ?>
				<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/logo-green.png" alt="Šumarski fakultet"></a>
			<?php } ?>
		</div>
