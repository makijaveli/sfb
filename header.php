	...
	<header>
			...
			<div class="wrapper">
				...
				<div class="headerright">
					...
					<div class="seacrhexpand">
					  ...
					  <input type="text" class="Search-box" name="s" id="Search-box" placeholder="Pretraga...">
		...
		<div class="headerlogo">
			...
			<?php if (stl_is_current_cyrillic()) { ?>
				<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/logo-cir.png" alt="Šumarski fakultet"></a>
			<?php } else { ?>
				<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/logo-lat.png" alt="Šumarski fakultet"></a>
			<?php } ?>
		</div>
