	...
	<header class="blue">
		...
		<div class="headerup">
			...
			<div class="wrapper">
				...
				<div class="seacrhexpand">
				  ...
				  <input type="text" class="Search-box blue" name="s" id="Search-box" placeholder="Search...">
		...
		<div class="headerlogo">
			...
			<?php if (stl_is_current_cyrillic()) { ?>
				<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/logo-blue-cir.png" alt="Šumarski fakultet"></a>
			<?php } else { ?>
				<a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/logo-blue.png" alt="Šumarski fakultet"></a>
			<?php } ?>
		</div>
